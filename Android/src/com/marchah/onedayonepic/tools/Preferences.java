...
public final class Preferences {
    ...
    public static void saveIdUser(Context context, int idUser) {
	SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
	SharedPreferences.Editor editor = preferences.edit();
	editor.putInt(Constants.SharedPreferences.IdUser, idUser);
	editor.commit();
    }
    
    public static int getIdUser(Context context) {
	SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
	return preferences.getInt(Constants.SharedPreferences.IdUser, 0);
    }
